...
const ProductDetails = () => {
    ...
    const stockStatus = (quantity) => {
        if(quantity > 0) {
            return <span className='bg-teal-600 rounded-lg dark: text-white px-2'>In Stock</span>
        }
        return <span className='bg-red'>Out of Stock</span>
    }
    ...
    <div className='h-auto w-full'>
        ...
        <div className='bg-gray-800 flex flex-col justify-center'>
            <form className='max-w-[1000px] w-full mx-auto bg-gray-900 p-8 m-5 rounded-lg'>
                ...
                <label className="text-2xl font-bold text-gray-300">Product Image</label>
                    <div>
                        {product?.image ? (
                ...
                <h4 className="text-4xl text-gray-300 font-bold">Product Availability: {stockStatus(product?.quantity)}</h4>
                <div className="text-gray-300">
                    ...
                    <hr/>
                    <div className='form-group space-y-3 py-5 text-lg text-gray-300'>
